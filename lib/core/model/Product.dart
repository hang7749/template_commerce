...
import 'package:mewmarketky/core/model/ColorWay.dart';
import 'package:mewmarketky/core/model/ProductSize.dart';
...
class Product {
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    try {
      ...
      throw Exception('Failed to parse Product from JSON: $e');
    }
  }
}
